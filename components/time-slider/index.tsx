...
type TimeSliderProps = {showedPartContent: React.ReactElement, questionPartQuestions: React.ReactElement}

const TimeSlider: React.FC<TimeSliderProps> = ({ showedPartContent, questionPartQuestions }) => {
