...
const Footer = () => {
  ...
  return (
    <S.FooterWrapper>
      <S.FooterSection>
        ...
        <S.ClickableIconContainer>
          <ClickableIconWrapper>
            {ICONS.map(icon => <ClickableIcon key={`clickable_icon_${icon.name}`} icon={icon.name} onClick={() => { }} />)}
          </ClickableIconWrapper>
        </S.ClickableIconContainer>
      ...
      <S.FooterSection>
        <P6><a href="https://www.freepik.com/free-psd/smartphone-mock-up-isolated_4075457.htm#query=phone&position=0&from_view=search&track=sph">Image by zlatko_plamenov</a> on Freepik</P6>
        <P6>
          Image by
